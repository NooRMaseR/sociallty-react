...
export const API_URL: string = DEBUG ? "http://192.168.1.9:8000" : "https://minimum-lauretta-noormaser-0d773dac.koyeb.app/";
export const MEDIA_URL: string = DEBUG ? "http://192.168.1.9:8000" : '';
export const WEBSOCKET_URL: string = DEBUG ? "ws://192.168.1.9:8000/ws" : API_URL;
