...
export const API_URL = DEBUG ? USELOCAL ? LOCAL_URL : "http://192.168.1.5:8000" : "https://successful-carlene-noormaser-5d3a002e.koyeb.app";
export const MEDIA_URL = DEBUG ? USELOCAL ? LOCAL_URL : "http://192.168.1.5:8000" : '';
export const WEBSOCKET_URL = DEBUG ? USELOCAL ? `${LOCAL_URL}/ws` : "ws://192.168.1.5:8000/ws" : `wss://successful-carlene-noormaser-5d3a002e.koyeb.app/ws`;
