...
interface StepperProps extends HTMLAttributes<HTMLDivElement> {
  children: ReactNode;
  initialStep?: number;
  beforeStepChange?: (updater: (step: number) => void) => void;
        ...
        {!isCompleted && (
          <div className={`footer-container ${footerClassName}`}>
            ...
            >
              ...
              >
                {loading ? "Please wait...." : isLastStep ? "Complete" : nextButtonText}
              </Button>
            </div>
          </div>
        )}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    incomplete: { width: 0, backgroundColor: "#00d8ff" },
